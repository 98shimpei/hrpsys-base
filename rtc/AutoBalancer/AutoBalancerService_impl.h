...
public:
  ...
  void startBoxBalancer(CORBA::Boolean coop_mode, CORBA::Double gain_pos, CORBA::Double gain_rot_p, CORBA::Double gain_rot_d);
  ...
  void getStabilizerParam(OpenHRP::AutoBalancerService::StabilizerParam_out i_param);
