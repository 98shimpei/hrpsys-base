...
void AutoBalancerService_impl::stopStabilizer(void)
{
  m_autobalancer->stopStabilizer();
}

void AutoBalancerService_impl::setBoxBalancer(CORBA::UShort t_id, CORBA::UShort b_id)
{
  m_autobalancer->setBoxBalancer(t_id, b_id);
}

void AutoBalancerService_impl::startBoxBalancer(CORBA::Boolean coop_mode, CORBA::Double gain_pos, CORBA::Double gain_rot_p, CORBA::Double gain_rot_d, CORBA::Double cut_off)
{
...
void AutoBalancerService_impl::jampBox(double p, double a, double ar, double x, double y, double z)
{
  m_autobalancer->jampBox(p, a, ar, x, y, z);
}
...
void AutoBalancerService_impl::setStabilizerParam(const OpenHRP::AutoBalancerService::StabilizerParam& i_param)
{
  m_autobalancer->setStabilizerParam(i_param);
}

void AutoBalancerService_impl::getStabilizerParam(OpenHRP::AutoBalancerService::StabilizerParam_out i_param)
{
