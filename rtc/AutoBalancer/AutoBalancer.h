  ...
  : public RTC::DataFlowComponentBase
{
 ...
 private:
  struct ABCIKparam {
    hrp::Vector3 target_p0, localPos, adjust_interpolation_target_p0, adjust_interpolation_org_p0, now_dest_p, pre_dest_p, pre_p, shimpei_vec, handfix_target_p0, hand_pos;
